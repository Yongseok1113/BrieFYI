...
class EmbedTest(unittest.TestCase):
    @mock.patch("rag.embed.config.HF_EMBEDDING_DIMENSION", 3)
    @mock.patch("rag.embed.config.HF_TOKEN", "test-token")
    @mock.patch("rag.embed.requests.post")
    ...
    @mock.patch("rag.embed.config.HF_TOKEN", "")
