...
class RagSearchDbTest(DbTestCase):
    ...
    @mock.patch("rag.db.config.HF_EMBEDDING_DIMENSION", 3)
    @mock.patch("rag.db.config.HF_EMBEDDING_MODEL", MODEL)
...
class ArticleIndexDbTest(DbTestCase):
    ...
    @mock.patch("rag.db.config.HF_EMBEDDING_DIMENSION", 3)
    @mock.patch("rag.db.config.HF_EMBEDDING_MODEL", "__test_embedding_model__")
