...
from rag_latest.retriever import _apply_metadata_boost, _combine_rrf_scores, retrieve
...
class HybridTest(unittest.TestCase):
    ...
    @mock.patch("rag_latest.retriever.db.text_search")
    @mock.patch("rag_latest.retriever.db.vector_search")
