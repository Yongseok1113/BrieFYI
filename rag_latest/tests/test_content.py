...
from rag_latest.content import build_article_text, fetch_article_body, split_text
...
class ArticleBodyTest(unittest.TestCase):
    @mock.patch("rag_latest.content.requests.get")
    ...
    @mock.patch(
        "rag_latest.content.requests.get",
